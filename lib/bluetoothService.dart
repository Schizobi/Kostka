...
abstract class BluetoothInterface{ // interfejs określający łączność bt
  List<BluetoothDeviceInterface> get devices;
  void startScan();
  void stopScan();
}

abstract class BluetoothDeviceInterface{ // interfejs definiujący urządzenie bt, trochę na wyrost
  String get name;
  String get id;
}
...
class BluetoothService implements BluetoothInterface{ // implementacja za pomocą biblioteki flutter_blue
